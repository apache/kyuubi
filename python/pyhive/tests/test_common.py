...
class TestCommon(unittest.TestCase):
    def test_escape_args(self):
        ...
        self.assertEqual(escaper.escape_args({"foo": 123.456}), {"foo": 123.456})
        self.assertEqual(
            escaper.escape_args({"foo": ["a", "b", "c"]}), {"foo": "('a','b','c')"}
        )
        self.assertEqual(
            escaper.escape_args({"foo": ("a", "b", "c")}), {"foo": "('a','b','c')"}
        )
        ...
        self.assertEqual(escaper.escape_args((["a", "b", "c"],)), ("('a','b','c')",))
        self.assertEqual(
            escaper.escape_args((["你好", "b", "c"],)), ("('你好','b','c')",)
        )
        self.assertEqual(
            escaper.escape_args((datetime.date(2020, 4, 17),)), ("'2020-04-17'",)
        )
        self.assertEqual(
