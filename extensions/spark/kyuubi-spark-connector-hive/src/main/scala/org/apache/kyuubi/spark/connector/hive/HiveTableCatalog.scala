...
import org.apache.spark.sql.hive.kyuubi.connector.KyuubiHiveConnectorBridgeHelper.{catalogV2Util, postExternalCatalogEvent, HiveExternalCatalog, HiveMetastoreCatalog, HiveSessionCatalog}
...
class HiveTableCatalog(sparkSession: SparkSession)
  ...
  override def createTable(
    ...
    import org.apache.spark.sql.hive.kyuubi.connector.KyuubiHiveConnectorBridgeHelper.TransformHelper
