...
public class DefaultConnectionUrlParserTest {
  ...
  @Test
  public void testDefaultUrl() throws BeelineHS2ConnectionFileParseException {
    System.setProperty("kyuubi.frontend.thrift.binary.bind.host", "localhost");
    ...
    String expected = "jdbc:hive2://localhost:10009/default";
