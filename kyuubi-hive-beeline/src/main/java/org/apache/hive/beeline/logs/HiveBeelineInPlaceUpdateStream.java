...
public class HiveBeelineInPlaceUpdateStream implements InPlaceUpdateStream {
  private InPlaceUpdate inPlaceUpdate;
  private EventNotifier notifier;

  public HiveBeelineInPlaceUpdateStream(PrintStream out, EventNotifier notifier) {
