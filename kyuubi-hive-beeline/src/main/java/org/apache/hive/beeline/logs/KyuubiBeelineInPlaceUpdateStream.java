...
public class KyuubiBeelineInPlaceUpdateStream implements KyuubiInPlaceUpdateStream {
  private InPlaceUpdate inPlaceUpdate;
  private EventNotifier notifier;

  public KyuubiBeelineInPlaceUpdateStream(PrintStream out, KyuubiInPlaceUpdateStream.EventNotifier notifier) {
