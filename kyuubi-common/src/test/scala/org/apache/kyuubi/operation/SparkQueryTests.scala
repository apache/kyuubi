...
trait SparkQueryTests extends HiveJDBCTestHelper {
  ...
  test("scala code with loading external package at runtime ") {
    ...
    withJdbcStatement() { statement =>
      ...
      // scalastyle:off
      println(jarStr)
      // magic string is base64 encoding of test-function.jar generated by new String(java.util.Base64.getEncoder().encode(jarBytes))
      val jarStrMagic =
        ""
      // scalastyle:on
      ...
      val batchCode =
        s"""
           ...
           |val jarFile = new File(dir, "test-function-$currentTime.jar")
           |val bos = new BufferedOutputStream(new FileOutputStream(jarFile))
           |val path = "$jarStrMagic"
