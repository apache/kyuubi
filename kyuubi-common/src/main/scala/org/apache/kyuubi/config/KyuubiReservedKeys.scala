...
object KyuubiReservedKeys {
  ...
  final val KYUUBI_SESSION_HANDLE_GUID = "kyuubi.session.handle.guid"
  final val KYUUBI_SESSION_HANDLE_SECRET = "kyuubi.session.handle.secret"
  ...
  final val KYUUBI_SESSION_SERVER_HOST = "kyuubi.session.server.host";
  final val KYUUBI_SESSION_SERVER_PORT = "kyuubi.session.server.port";
