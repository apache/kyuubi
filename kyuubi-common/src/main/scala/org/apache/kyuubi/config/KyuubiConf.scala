...
object KyuubiConf {
  ...
  val FRONTEND_REST_USE_SSL: ConfigEntry[Boolean] =
    buildConf("kyuubi.frontend.rest.use.SSL")
      .doc("Set this to true for using SSL encryption in http mode.")
      .version("1.9.0")
      .booleanConf
      .createWithDefault(false)

  val FRONTEND_REST_SSL_KEYSTORE_PATH: OptionalConfigEntry[String] =
    buildConf("kyuubi.frontend.rest.ssl.keystore.path")
      .doc("SSL certificate keystore location.")
      .version("1.9.0")
      .withAlternative("kyuubi.frontend.ssl.keystore.path")
      .stringConf
  ...
  val FRONTEND_REST_SSL_KEYSTORE_PASSWORD: OptionalConfigEntry[String] =
    buildConf("kyuubi.frontend.rest.ssl.keystore.password")
      .doc("SSL certificate keystore password.")
      .version("1.9.0")
      .serverOnly
      .withAlternative("kyuubi.frontend.ssl.keystore.password")
  ...
  val FRONTEND_REST_SSL_PROTOCOL_BLACKLIST: ConfigEntry[Seq[String]] =
    buildConf("kyuubi.frontend.rest.ssl.protocol.blacklist")
      .doc("SSL Versions to disable when using HTTP transport mode.")
      .version("1.9.0")
      .stringConf
      .toSequence()
  ...
  val FRONTEND_REST_SSL_EXCLUDE_CIPHER_SUITES: ConfigEntry[Seq[String]] =
    buildConf("kyuubi.frontend.rest.ssl.exclude.ciphersuites")
      .doc("A comma-separated list of exclude SSL cipher suite names for thrift http frontend.")
      .version("1.9.0")
      .stringConf
      .toSequence()
  ...
  val FRONTEND_REST_ALLOW_USER_SUBSTITUTION: ConfigEntry[Boolean] =
    buildConf("kyuubi.frontend.rest.allow.user.substitution")
      .doc("Allow alternate user to be specified as part of open connection" +
        " request when using HTTP transport mode.")
      .version("1.9.0")
      .booleanConf
