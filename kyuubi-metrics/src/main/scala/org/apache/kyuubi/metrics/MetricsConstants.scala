...
object MetricsConstants {
  ...
  final private val MYSQL_CONN = KYUUBI + "mysql.connection."
  ...
  final val MYSQL_CONN_OPEN: String = MYSQL_CONN + "opened"
  final val MYSQL_CONN_FAIL: String = MYSQL_CONN + "failed"
  final val MYSQL_CONN_TOTAL: String = MYSQL_CONN + "total"
