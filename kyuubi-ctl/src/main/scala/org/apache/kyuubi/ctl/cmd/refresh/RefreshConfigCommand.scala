...
import org.apache.kyuubi.ctl.cmd.refresh.RefreshConfigCommandConfigType.{HADOOP_CONF, KUBERNETES_CONF, LIMITED_USERS, UNLIMITED_USERS, USER_DEFAULTS_CONF}
  ...
  def doRun(): String = {
    withKyuubiRestClient(normalizedCliConfig, null, conf) { kyuubiRestClient =>
      ...
      normalizedCliConfig.adminConfigOpts.configType match {
        ...
        case LIMITED_USERS => adminRestApi.refreshLimitedUsers()
...
object RefreshConfigCommandConfigType {
  ...
  final val LIMITED_USERS = "limitedUsers"
}
