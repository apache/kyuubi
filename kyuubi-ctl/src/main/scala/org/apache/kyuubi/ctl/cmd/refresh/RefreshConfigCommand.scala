...
import org.apache.kyuubi.ctl.cmd.refresh.RefreshConfigCommandConfigType.{BLACKLIST_USERS, HADOOP_CONF, KUBERNETES_CONF, UNLIMITED_USERS, USER_DEFAULTS_CONF}
  ...
  def doRun(): String = {
    withKyuubiRestClient(normalizedCliConfig, null, conf) { kyuubiRestClient =>
      ...
      normalizedCliConfig.adminConfigOpts.configType match {
        ...
        case BLACKLIST_USERS => adminRestApi.refreshBlacklistUsers()
...
object RefreshConfigCommandConfigType {
  ...
  final val BLACKLIST_USERS = "blacklistUsers"
}
