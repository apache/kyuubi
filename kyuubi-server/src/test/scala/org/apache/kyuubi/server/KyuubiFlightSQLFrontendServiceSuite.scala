...
import org.apache.kyuubi.service.NoopFlightSQLFrontendServer
import org.apache.kyuubi.service.ServiceState._

class KyuubiFlightSQLFrontendServiceSuite extends KyuubiFunSuite {

  test("Kyuubi Arrow Flight SQL frontend service basic") {
    val server = new NoopFlightSQLFrontendServer
    server.stop()
    val conf = KyuubiConf()
