...
import org.apache.kyuubi.service.NoopHttpFrontendServer
import org.apache.kyuubi.service.ServiceState._

class KyuubiTHttpFrontendServiceSuite extends KyuubiFunSuite {

  test("Kyuubi Http frontend service basic") {
    val server = new NoopHttpFrontendServer
    server.stop()
    val conf = KyuubiConf()
