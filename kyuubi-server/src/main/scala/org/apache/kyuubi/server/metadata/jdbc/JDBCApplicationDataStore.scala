...
import org.apache.kyuubi.server.metadata.ApplicationDataStore

class JDBCApplicationDataStore extends ApplicationDataStore with Logging {
...
object JDBCApplicationDataStore extends Logging {
  def apply(): JDBCApplicationDataStore = {
    new JDBCApplicationDataStore()
  }
}
