...
Refresh the [user defaults configs](project:../../deployment/settings.md#user-defaults) with key in format in the form of `___{username}___.{config key}` from default property file.
