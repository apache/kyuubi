...
kyuubi.spark.sql.classification.enabled | true | When true, allows Kyuubi engine to judge this SQL's classification and set it into sessionConf. Through this configuration item, Spark can optimizing configuration dynamic. | 1.4.0
