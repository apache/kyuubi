...
kyuubi\.metrics<br>\.exporters|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>PROMETHEUS</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>A comma separated list for all metrics exporters<ul> <li>JSON - Output measurements to file formatted by JSON each line.</li> <li>SLF4J - Output measurements to system log.</li> <li>PROMETHEUS - Expose measurements to Prometheus over HTTP server.</li></ul></div>|<div style='width: 30pt'>seq</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics<br>\.histogram|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Set to true to enable publish percentiles histogram in summary and timer metrics</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics\.json<br>\.interval|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>PT1M</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>How often should output measurements to json files. The default is 1 minute.</div>|<div style='width: 30pt'>duration</div>|<div style='width: 20pt'>1.2.0</div>
...
kyuubi\.metrics<br>\.prometheus\.context<br>\.path|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>/metrics</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>HTTP Server context path to expose the prometheus metrics.</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics<br>\.prometheus<br>\.description|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Whether meter descriptions should be sent to Prometheus. Turn this off to minimize the amount of data sent on each scrape</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics<br>\.prometheus\.host|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>HTTP Server hostname or IP of the machine on which to expose the prometheus metrics.</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics<br>\.prometheus\.interval|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>PT1M</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>The step size to use in computing windowed statistics like max. To get the most out of these statistics, align the step interval to be close to your scrape interval</div>|<div style='width: 30pt'>duration</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics<br>\.prometheus\.port|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>10090</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>HTTP Server port of the machine on which to expose the prometheus metrics.</div>|<div style='width: 30pt'>int</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics\.slf4j<br>\.interval|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>PT1M</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>How often should output measurements to slf4j. The default is 1 minute.</div>|<div style='width: 30pt'>duration</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics\.slf4j<br>\.log\.inactive|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Whether counters and timers that have no activity in an interval are still logged.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.2.0</div>
kyuubi\.metrics\.slf4j<br>\.logger|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>kyuubi.metrics</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>SLF4J metrics exporter logger name, default kyuubi.metrics</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.2.0</div>
