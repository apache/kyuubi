...
<code>kyuubi.operation.query.timeout.compatible.state</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>false</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Clients less than version 2.1 have no HIVE-4924 Patch, no queryTimeout parameter and no TIMEOUT status. When the server enables kyuubi.operation.query.timeout, this will cause the client of the lower version to get stuck.when true, regardless of the version of the client, the queryTimeout parameter is not set, and the TIMEOUT state is converted to CANCELED. If queryTimeout is set, the TIMEOUT state is still maintained.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.6.0</div>
