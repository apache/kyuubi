...
<code>kyuubi.session.engine.spark.max.rows</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>0</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Max rows of Spark query results. Rows that exceeds the limit would be ignored. By setting this value to 0 to disable the max rows limit.</div>|<div style='width: 30pt'>int</div>|<div style='width: 20pt'>1.6.0</div>
