...
Key | Default | Meaning | Type | Since
--- | --- | --- | --- | ---
kyuubi\.ha\.engine\.pool<br>\.size|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>1</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Maximum number of engines when using USER share level.</div>|<div style='width: 30pt'>int</div>|<div style='width: 20pt'>1.4.0</div>
kyuubi\.ha\.engine<br>\.provide\.policy|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>RANDOM</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Multiple engines can be exposed under same space when using USER share level, choose the appropriate strategy according to different scenarios.</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.4.0</div>
