...
kyuubi\.engine\.event<br>\.store\.jdbc\.url|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>This configuration item is used for storing engine/session/operation informationinto database. Now just support innodb engine. When you set this item, you should add username and password for this DB. First, you should set ConfigEntry(key=kyuubi.engine.event.loggers, defaultValue=SPARK, doc=A comma separated list of engine history loggers, where engine/session/operation etc events go. We use spark logger by default.<ul> <li>SPARK: the events will be written to the spark listener bus.</li> <li>JSON: the events will be written to the location of kyuubi.engine.event.json.log.path</li> <li>JDBC: to be done</li> <li>CUSTOM: to be done.</li></ul>, version=1.3.0, type=seq) to 'JDBC'.When you use this way to store engine events, you should copy mysql-connector-java-#{version}.jar into path:#{SPARK_HOME}/jars The format is : jdbc:mysql://<username>:<password>@<host>:<port>/<db></div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.5.0</div>
...
Key | Default | Meaning | Type | Since
--- | --- | --- | --- | ---
kyuubi\.server\.cluster|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>default</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>It just shows which cluster this server belong to.</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.5.0</div>
