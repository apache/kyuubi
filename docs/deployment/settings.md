...
kyuubi\.engine\.host<br>\.use\.hostName|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When true, as normal run.When false, will submit --conf spark.driver.host=$LOCALHOST.IP</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.5.0</div>
