...
kyuubi\.engine\.sql<br>\.type\.enabled|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When true, allows Kyuubi engine to judge this SQL's type and set it into sessionConf.Through this configuration item, Spark can optimizing configuration dynamic</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.3.0</div>
