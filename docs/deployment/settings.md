...
kyuubi\.session\.engine<br>\.startup<br>\.waitCompletion|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Whether to wait for completion after engine starts. If false, the startup process will be destroyed after the engine is started.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.5.0</div>
