...
kyuubi\.session\.conf<br>\.advisor|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>org.apache.kyuubi.plugin.DefaultSessionConfAdvisor</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>Choose a custom config advisor for session, the default implementation return empty.</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.5.0</div>
