...
kyuubi\.engine\.sync<br>\.init|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>when opening kyuubi session, whether to init backend engine synchronously</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.4.0</div>
