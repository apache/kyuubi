...
kyuubi.operation.result.compression.codec|lz4|The codec used to compress arrow-based result. By default, Kyuubi provides three codecs: `lz4`, `zstd`, `gzip`|string|1.7.0
