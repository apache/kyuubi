...
<code>kyuubi.engine.spark.register.operation.listener</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>true</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When set to true, Spark engine registers a SQLOperationListener before executing the statement, logs a few summary statistics when each stage completes.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.6.0</div>
