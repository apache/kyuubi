...
<code>kyuubi.session.engine.spark.scalaReplToOperationLog</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>false</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>When true, enable kyuubi.operation.language to SCALA, pass scala repl output to operation log.</div>|<div style='width: 30pt'>boolean</div>|<div style='width: 20pt'>1.6.0</div>
