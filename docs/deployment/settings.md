...
<code>kyuubi.session.conf.advisor</code>|<div style='width: 65pt;word-wrap: break-word;white-space: normal'>&lt;undefined&gt;</div>|<div style='width: 170pt;word-wrap: break-word;white-space: normal'>A config advisor plugin for Kyuubi Server. This plugin can provide some custom configs for different user or session configs and overwrite the session config before open a new session. This config value should be a class which is a child of org.apache.kyuubi.plugin.SessionConfAdvisor.</div>|<div style='width: 30pt'>string</div>|<div style='width: 20pt'>1.5.0</div>
