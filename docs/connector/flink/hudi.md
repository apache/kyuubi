...
3. `hudi-flink<flink.version>-bundle-<hudi.version>.jar` (example: `hudi-flink1.20-bundle-1.0.1.jar`), which can be found in the [Maven Central](https://mvnrepository.com/artifact/org.apache.hudi)
