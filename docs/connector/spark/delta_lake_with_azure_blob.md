...
Regarding the Microsoft Azure account, please contact your organization or register an account as an individual.
For details, please refer to the [Microsoft Azure official website](https://azure.microsoft.com/en-gb/).

### Create Storage Container

After logging in with your Microsoft Azure account, please follow the steps below to create a data storage container:

![Azure create new container](../../imgs/deltalake/azure_create_new_container.png)

### Get Access Key

![Azure create azure access key](../../imgs/deltalake/azure_create_azure_access_key.png)

## Deploy Spark

### Download Spark Package

Download spark package that matches your environment from [spark official website](https://spark.apache.org/downloads.html).
And then unpackage:
...
After this, you can check your data on azure web UI.
For example, my container name is 1000 and table name is alexDemo20211127:

![Azure spark connection test storage](../../imgs/deltalake/azure_spark_connection_test_storage.png)
...
![Kyuubi start status spark UI](../../imgs/deltalake/kyuubi_start_status_spark_UI.png)

When the engine started, it will expose a thrift endpoint and register itself into
ZooKeeper, Kyuubi server can get the connection info from ZooKeeper and establish the connection to the engine.
