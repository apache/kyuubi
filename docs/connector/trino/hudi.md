...
you can obtain it from its [Official Documentation](https://hudi.apache.org/docs/overview).
```
...
These statements can be found in [Trino SQL Support](https://trino.io/docs/current/language/sql-support.html).
