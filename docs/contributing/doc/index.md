...
Kyuubi's documentation source files are maintained in the same [github repository](https://github.com/apache/kyuubi)
...
Kyuubi's documentation is published and hosted on [Read The Docs](https://kyuubi.rtfd.io) platform by
version. with each version having its own dedicated page. To access a specific
version of the document, simply navigate to the "Docs" tab on our [Home Page](https://kyuubi.apache.org).
