...
| spark.sql.finalWriteStageResourceIsolation.enabled                  | false                                  | When true, make final write stage resource isolation using custom RDD resource profile.                                                                                                                                                                                                                                                              | 1.8.0 |
| spark.sql.finalWriteStageNumPartitionFactor                         | 1                                      | If the target executors * factor < active executors, and target executors > min executors, then inject kill executors or inject custom resource profile.                                                                                                                                                                                             | 1.8.0 |
