...
public class HiveServer2Instance extends ServiceInstanceBase {
  ...
  public HiveServer2Instance(final ServiceRecord srv, final String endPointName)
      throws IOException {
    ...
    Preconditions.checkArgument(
        activeEndpoint == null || passiveEndpoint == null,
  ...
  public int hashCode() {
    return super.hashCode()
        + Objects.hashCode(isLeader)
        + Objects.hashCode(transportMode)
        + Objects.hashCode(httpEndpoint);
  }
