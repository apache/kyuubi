...
package org.apache.kyuubi.jdbc.service.server;
...
public class HS2ActivePassiveHARegistryClient {
  ...
  /**
   * Helper method to get a HiveServer2HARegistry instance to read from the registry. Only used by
   * clients (JDBC), service discovery to connect to active HS2 instance in Active/Passive HA
   * configuration.
   *
   * @param conf {@link Configuration} instance which contains service registry information.
   * @return HiveServer2HARegistry
   */
  public static synchronized HS2ActivePassiveHARegistry getClient(Configuration conf)
      throws IOException {
    String namespace =
