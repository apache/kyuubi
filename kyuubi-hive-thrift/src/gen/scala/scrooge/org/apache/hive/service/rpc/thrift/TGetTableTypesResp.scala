...
object TGetTableTypesResp extends ValidatingThriftStructCodec3[TGetTableTypesResp] with StructBuilderFactory[TGetTableTypesResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetTableTypesResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetTableTypesResp]] = {
    Seq(
      new ThriftStructField[TGetTableTypesResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetTableTypesResp]) {
          def getValue[R](struct: TGetTableTypesResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetTableTypesResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetTableTypesResp]) {
          def getValue[R](struct: TGetTableTypesResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetTableTypesResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetTableTypesResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetTableTypesResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetTableTypesResp): TGetTableTypesResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetTableTypesResp] = new TGetTableTypesRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetTableTypesResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetTableTypesResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetTableTypesResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetTableTypesResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetTableTypesResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetTableTypesResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetTableTypesResp] {
    override def encode(_item: TGetTableTypesResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetTableTypesResp = TGetTableTypesResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetTableTypesResp] = TGetTableTypesResp.metaData
  }

  /**
   * The default read-only implementation of TGetTableTypesResp.  You typically should not need to
   * directly reference this class; instead, use the TGetTableTypesResp.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the TGetTableTypesResp trait with additional state or
   * behavior and implement the read-only methods from TGetTableTypesResp using an underlying
   * instance.
   */
  trait Proxy extends TGetTableTypesResp {
    protected def _underlying_TGetTableTypesResp: TGetTableTypesResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetTableTypesResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetTableTypesResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetTableTypesResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetTableTypesResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetTableTypesResp
  ...
  with ValidatingThriftStruct[TGetTableTypesResp]
  with java.io.Serializable
{
  import TGetTableTypesResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetTableTypesResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetTableTypesResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetTableTypesResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetTableTypesResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetTableTypesResp = unsetField(1)

  def unsetOperationHandle: TGetTableTypesResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetTableTypesResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetTableTypesResp]

  private def _equals(x: TGetTableTypesResp, y: TGetTableTypesResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetTableTypesResp])
  ...
  override def productPrefix: String = "TGetTableTypesResp"

  def _codec: ValidatingThriftStructCodec3[TGetTableTypesResp] = TGetTableTypesResp

  def newBuilder(): StructBuilder[TGetTableTypesResp] = new TGetTableTypesRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetTableTypesRespStructBuilder(instance: _root_.scala.Option[TGetTableTypesResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetTableTypesResp](fieldTypes) {

  def build(): TGetTableTypesResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetTableTypesResp"))
      else {
        TGetTableTypesResp(
