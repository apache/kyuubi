...
object TGetCrossReferenceResp extends ValidatingThriftStructCodec3[TGetCrossReferenceResp] with StructBuilderFactory[TGetCrossReferenceResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetCrossReferenceResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetCrossReferenceResp]] = {
    Seq(
      new ThriftStructField[TGetCrossReferenceResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetCrossReferenceResp]) {
          def getValue[R](struct: TGetCrossReferenceResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetCrossReferenceResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetCrossReferenceResp]) {
          def getValue[R](struct: TGetCrossReferenceResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetCrossReferenceResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetCrossReferenceResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetCrossReferenceResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetCrossReferenceResp): TGetCrossReferenceResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetCrossReferenceResp] = new TGetCrossReferenceRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetCrossReferenceResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetCrossReferenceResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetCrossReferenceResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetCrossReferenceResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetCrossReferenceResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetCrossReferenceResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetCrossReferenceResp] {
    override def encode(_item: TGetCrossReferenceResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetCrossReferenceResp = TGetCrossReferenceResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetCrossReferenceResp] = TGetCrossReferenceResp.metaData
  }

  /**
   * The default read-only implementation of TGetCrossReferenceResp.  You typically should not need to
   * directly reference this class; instead, use the TGetCrossReferenceResp.apply method to construct
   * new instances.
   */
  class Immutable(
    ...
    extends TGetCrossReferenceResp {
    def this(
      status: org.apache.hive.service.rpc.thrift.TStatus,
      operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _root_.scala.None
    ) = this(
  ...
  /**
   * This Proxy trait allows you to extend the TGetCrossReferenceResp trait with additional state or
   * behavior and implement the read-only methods from TGetCrossReferenceResp using an underlying
   * instance.
   */
  trait Proxy extends TGetCrossReferenceResp {
    protected def _underlying_TGetCrossReferenceResp: TGetCrossReferenceResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetCrossReferenceResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetCrossReferenceResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetCrossReferenceResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetCrossReferenceResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetCrossReferenceResp
  ...
  with ValidatingThriftStruct[TGetCrossReferenceResp]
  with java.io.Serializable
{
  import TGetCrossReferenceResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetCrossReferenceResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetCrossReferenceResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetCrossReferenceResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetCrossReferenceResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetCrossReferenceResp = unsetField(1)

  def unsetOperationHandle: TGetCrossReferenceResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetCrossReferenceResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetCrossReferenceResp]

  private def _equals(x: TGetCrossReferenceResp, y: TGetCrossReferenceResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetCrossReferenceResp])
  ...
  override def productPrefix: String = "TGetCrossReferenceResp"

  def _codec: ValidatingThriftStructCodec3[TGetCrossReferenceResp] = TGetCrossReferenceResp

  def newBuilder(): StructBuilder[TGetCrossReferenceResp] = new TGetCrossReferenceRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetCrossReferenceRespStructBuilder(instance: _root_.scala.Option[TGetCrossReferenceResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetCrossReferenceResp](fieldTypes) {

  def build(): TGetCrossReferenceResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetCrossReferenceResp"))
      else {
        TGetCrossReferenceResp(
