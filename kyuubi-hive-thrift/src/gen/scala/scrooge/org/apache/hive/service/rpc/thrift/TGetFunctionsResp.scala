...
object TGetFunctionsResp extends ValidatingThriftStructCodec3[TGetFunctionsResp] with StructBuilderFactory[TGetFunctionsResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetFunctionsResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetFunctionsResp]] = {
    Seq(
      new ThriftStructField[TGetFunctionsResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetFunctionsResp]) {
          def getValue[R](struct: TGetFunctionsResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetFunctionsResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetFunctionsResp]) {
          def getValue[R](struct: TGetFunctionsResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetFunctionsResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetFunctionsResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetFunctionsResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetFunctionsResp): TGetFunctionsResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetFunctionsResp] = new TGetFunctionsRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetFunctionsResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetFunctionsResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetFunctionsResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetFunctionsResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetFunctionsResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetFunctionsResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetFunctionsResp] {
    override def encode(_item: TGetFunctionsResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetFunctionsResp = TGetFunctionsResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetFunctionsResp] = TGetFunctionsResp.metaData
  }

  /**
   * The default read-only implementation of TGetFunctionsResp.  You typically should not need to
   * directly reference this class; instead, use the TGetFunctionsResp.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the TGetFunctionsResp trait with additional state or
   * behavior and implement the read-only methods from TGetFunctionsResp using an underlying
   * instance.
   */
  trait Proxy extends TGetFunctionsResp {
    protected def _underlying_TGetFunctionsResp: TGetFunctionsResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetFunctionsResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetFunctionsResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetFunctionsResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetFunctionsResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetFunctionsResp
  ...
  with ValidatingThriftStruct[TGetFunctionsResp]
  with java.io.Serializable
{
  import TGetFunctionsResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetFunctionsResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetFunctionsResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetFunctionsResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetFunctionsResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetFunctionsResp = unsetField(1)

  def unsetOperationHandle: TGetFunctionsResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetFunctionsResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetFunctionsResp]

  private def _equals(x: TGetFunctionsResp, y: TGetFunctionsResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetFunctionsResp])
  ...
  override def productPrefix: String = "TGetFunctionsResp"

  def _codec: ValidatingThriftStructCodec3[TGetFunctionsResp] = TGetFunctionsResp

  def newBuilder(): StructBuilder[TGetFunctionsResp] = new TGetFunctionsRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetFunctionsRespStructBuilder(instance: _root_.scala.Option[TGetFunctionsResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetFunctionsResp](fieldTypes) {

  def build(): TGetFunctionsResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetFunctionsResp"))
      else {
        TGetFunctionsResp(
