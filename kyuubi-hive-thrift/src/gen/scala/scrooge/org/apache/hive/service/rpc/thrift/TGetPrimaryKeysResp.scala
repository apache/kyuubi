...
object TGetPrimaryKeysResp extends ValidatingThriftStructCodec3[TGetPrimaryKeysResp] with StructBuilderFactory[TGetPrimaryKeysResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetPrimaryKeysResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetPrimaryKeysResp]] = {
    Seq(
      new ThriftStructField[TGetPrimaryKeysResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetPrimaryKeysResp]) {
          def getValue[R](struct: TGetPrimaryKeysResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetPrimaryKeysResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetPrimaryKeysResp]) {
          def getValue[R](struct: TGetPrimaryKeysResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetPrimaryKeysResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetPrimaryKeysResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetPrimaryKeysResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetPrimaryKeysResp): TGetPrimaryKeysResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetPrimaryKeysResp] = new TGetPrimaryKeysRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetPrimaryKeysResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetPrimaryKeysResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetPrimaryKeysResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetPrimaryKeysResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetPrimaryKeysResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetPrimaryKeysResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetPrimaryKeysResp] {
    override def encode(_item: TGetPrimaryKeysResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetPrimaryKeysResp = TGetPrimaryKeysResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetPrimaryKeysResp] = TGetPrimaryKeysResp.metaData
  }

  /**
   * The default read-only implementation of TGetPrimaryKeysResp.  You typically should not need to
   * directly reference this class; instead, use the TGetPrimaryKeysResp.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the TGetPrimaryKeysResp trait with additional state or
   * behavior and implement the read-only methods from TGetPrimaryKeysResp using an underlying
   * instance.
   */
  trait Proxy extends TGetPrimaryKeysResp {
    protected def _underlying_TGetPrimaryKeysResp: TGetPrimaryKeysResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetPrimaryKeysResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetPrimaryKeysResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetPrimaryKeysResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetPrimaryKeysResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetPrimaryKeysResp
  ...
  with ValidatingThriftStruct[TGetPrimaryKeysResp]
  with java.io.Serializable
{
  import TGetPrimaryKeysResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetPrimaryKeysResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetPrimaryKeysResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetPrimaryKeysResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetPrimaryKeysResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetPrimaryKeysResp = unsetField(1)

  def unsetOperationHandle: TGetPrimaryKeysResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetPrimaryKeysResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetPrimaryKeysResp]

  private def _equals(x: TGetPrimaryKeysResp, y: TGetPrimaryKeysResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetPrimaryKeysResp])
  ...
  override def productPrefix: String = "TGetPrimaryKeysResp"

  def _codec: ValidatingThriftStructCodec3[TGetPrimaryKeysResp] = TGetPrimaryKeysResp

  def newBuilder(): StructBuilder[TGetPrimaryKeysResp] = new TGetPrimaryKeysRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetPrimaryKeysRespStructBuilder(instance: _root_.scala.Option[TGetPrimaryKeysResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetPrimaryKeysResp](fieldTypes) {

  def build(): TGetPrimaryKeysResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetPrimaryKeysResp"))
      else {
        TGetPrimaryKeysResp(
