...
object TGetTypeInfoResp extends ValidatingThriftStructCodec3[TGetTypeInfoResp] with StructBuilderFactory[TGetTypeInfoResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetTypeInfoResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetTypeInfoResp]] = {
    Seq(
      new ThriftStructField[TGetTypeInfoResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetTypeInfoResp]) {
          def getValue[R](struct: TGetTypeInfoResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetTypeInfoResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetTypeInfoResp]) {
          def getValue[R](struct: TGetTypeInfoResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetTypeInfoResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetTypeInfoResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetTypeInfoResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetTypeInfoResp): TGetTypeInfoResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetTypeInfoResp] = new TGetTypeInfoRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetTypeInfoResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetTypeInfoResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetTypeInfoResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetTypeInfoResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetTypeInfoResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetTypeInfoResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetTypeInfoResp] {
    override def encode(_item: TGetTypeInfoResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetTypeInfoResp = TGetTypeInfoResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetTypeInfoResp] = TGetTypeInfoResp.metaData
  }

  /**
   * The default read-only implementation of TGetTypeInfoResp.  You typically should not need to
   * directly reference this class; instead, use the TGetTypeInfoResp.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the TGetTypeInfoResp trait with additional state or
   * behavior and implement the read-only methods from TGetTypeInfoResp using an underlying
   * instance.
   */
  trait Proxy extends TGetTypeInfoResp {
    protected def _underlying_TGetTypeInfoResp: TGetTypeInfoResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetTypeInfoResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetTypeInfoResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetTypeInfoResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetTypeInfoResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetTypeInfoResp
  ...
  with ValidatingThriftStruct[TGetTypeInfoResp]
  with java.io.Serializable
{
  import TGetTypeInfoResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetTypeInfoResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetTypeInfoResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetTypeInfoResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetTypeInfoResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetTypeInfoResp = unsetField(1)

  def unsetOperationHandle: TGetTypeInfoResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetTypeInfoResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetTypeInfoResp]

  private def _equals(x: TGetTypeInfoResp, y: TGetTypeInfoResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetTypeInfoResp])
  ...
  override def productPrefix: String = "TGetTypeInfoResp"

  def _codec: ValidatingThriftStructCodec3[TGetTypeInfoResp] = TGetTypeInfoResp

  def newBuilder(): StructBuilder[TGetTypeInfoResp] = new TGetTypeInfoRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetTypeInfoRespStructBuilder(instance: _root_.scala.Option[TGetTypeInfoResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetTypeInfoResp](fieldTypes) {

  def build(): TGetTypeInfoResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetTypeInfoResp"))
      else {
        TGetTypeInfoResp(
