...
object TGetCatalogsResp extends ValidatingThriftStructCodec3[TGetCatalogsResp] with StructBuilderFactory[TGetCatalogsResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetCatalogsResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetCatalogsResp]] = {
    Seq(
      new ThriftStructField[TGetCatalogsResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetCatalogsResp]) {
          def getValue[R](struct: TGetCatalogsResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetCatalogsResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetCatalogsResp]) {
          def getValue[R](struct: TGetCatalogsResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetCatalogsResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetCatalogsResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetCatalogsResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetCatalogsResp): TGetCatalogsResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetCatalogsResp] = new TGetCatalogsRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetCatalogsResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetCatalogsResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetCatalogsResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetCatalogsResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetCatalogsResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetCatalogsResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetCatalogsResp] {
    override def encode(_item: TGetCatalogsResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetCatalogsResp = TGetCatalogsResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetCatalogsResp] = TGetCatalogsResp.metaData
  }

  /**
   * The default read-only implementation of TGetCatalogsResp.  You typically should not need to
   * directly reference this class; instead, use the TGetCatalogsResp.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the TGetCatalogsResp trait with additional state or
   * behavior and implement the read-only methods from TGetCatalogsResp using an underlying
   * instance.
   */
  trait Proxy extends TGetCatalogsResp {
    protected def _underlying_TGetCatalogsResp: TGetCatalogsResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetCatalogsResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetCatalogsResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetCatalogsResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetCatalogsResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetCatalogsResp
  ...
  with ValidatingThriftStruct[TGetCatalogsResp]
  with java.io.Serializable
{
  import TGetCatalogsResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetCatalogsResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetCatalogsResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetCatalogsResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetCatalogsResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetCatalogsResp = unsetField(1)

  def unsetOperationHandle: TGetCatalogsResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetCatalogsResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetCatalogsResp]

  private def _equals(x: TGetCatalogsResp, y: TGetCatalogsResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetCatalogsResp])
  ...
  override def productPrefix: String = "TGetCatalogsResp"

  def _codec: ValidatingThriftStructCodec3[TGetCatalogsResp] = TGetCatalogsResp

  def newBuilder(): StructBuilder[TGetCatalogsResp] = new TGetCatalogsRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetCatalogsRespStructBuilder(instance: _root_.scala.Option[TGetCatalogsResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetCatalogsResp](fieldTypes) {

  def build(): TGetCatalogsResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetCatalogsResp"))
      else {
        TGetCatalogsResp(
