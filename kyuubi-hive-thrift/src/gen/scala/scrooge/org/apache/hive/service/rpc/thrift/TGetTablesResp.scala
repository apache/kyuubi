...
object TGetTablesResp extends ValidatingThriftStructCodec3[TGetTablesResp] with StructBuilderFactory[TGetTablesResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetTablesResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetTablesResp]] = {
    Seq(
      new ThriftStructField[TGetTablesResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetTablesResp]) {
          def getValue[R](struct: TGetTablesResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetTablesResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetTablesResp]) {
          def getValue[R](struct: TGetTablesResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetTablesResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetTablesResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetTablesResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetTablesResp): TGetTablesResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetTablesResp] = new TGetTablesRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetTablesResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetTablesResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetTablesResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetTablesResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetTablesResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetTablesResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetTablesResp] {
    override def encode(_item: TGetTablesResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetTablesResp = TGetTablesResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetTablesResp] = TGetTablesResp.metaData
  }

  /**
   * The default read-only implementation of TGetTablesResp.  You typically should not need to
   * directly reference this class; instead, use the TGetTablesResp.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the TGetTablesResp trait with additional state or
   * behavior and implement the read-only methods from TGetTablesResp using an underlying
   * instance.
   */
  trait Proxy extends TGetTablesResp {
    protected def _underlying_TGetTablesResp: TGetTablesResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetTablesResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetTablesResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetTablesResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetTablesResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetTablesResp
  ...
  with ValidatingThriftStruct[TGetTablesResp]
  with java.io.Serializable
{
  import TGetTablesResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetTablesResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetTablesResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetTablesResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetTablesResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetTablesResp = unsetField(1)

  def unsetOperationHandle: TGetTablesResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetTablesResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetTablesResp]

  private def _equals(x: TGetTablesResp, y: TGetTablesResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetTablesResp])
  ...
  override def productPrefix: String = "TGetTablesResp"

  def _codec: ValidatingThriftStructCodec3[TGetTablesResp] = TGetTablesResp

  def newBuilder(): StructBuilder[TGetTablesResp] = new TGetTablesRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetTablesRespStructBuilder(instance: _root_.scala.Option[TGetTablesResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetTablesResp](fieldTypes) {

  def build(): TGetTablesResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetTablesResp"))
      else {
        TGetTablesResp(
