...
object TGetColumnsResp extends ValidatingThriftStructCodec3[TGetColumnsResp] with StructBuilderFactory[TGetColumnsResp] {
  val NoPassthroughFields: immutable$Map[Short, TFieldBlob] = immutable$Map.empty[Short, TFieldBlob]
  val Struct: TStruct = new TStruct("TGetColumnsResp")
  ...
  private[this] val structFields: Seq[ThriftStructField[TGetColumnsResp]] = {
    Seq(
      new ThriftStructField[TGetColumnsResp](
        StatusField,
        _root_.scala.Some(StatusFieldManifest),
        classOf[TGetColumnsResp]) {
          def getValue[R](struct: TGetColumnsResp): R = struct.status.asInstanceOf[R]
      },
      new ThriftStructField[TGetColumnsResp](
        OperationHandleField,
        _root_.scala.Some(OperationHandleFieldManifest),
        classOf[TGetColumnsResp]) {
          def getValue[R](struct: TGetColumnsResp): R = struct.operationHandle.asInstanceOf[R]
      }
    )
  }

  override lazy val metaData: ThriftStructMetaData[TGetColumnsResp] =
    new ThriftStructMetaData(this, structFields, fieldInfos, Seq(), structAnnotations)

  /**
   * Checks that all required fields are non-null.
   */
  def validate(_item: TGetColumnsResp): Unit = {
   ...
   */
  def validateNewInstance(item: TGetColumnsResp): scala.Seq[com.twitter.scrooge.validation.Issue] = {
  ...
  def withoutPassthroughFields(original: TGetColumnsResp): TGetColumnsResp =
    new Immutable(
      status =
        {
  ...
  def newBuilder(): StructBuilder[TGetColumnsResp] = new TGetColumnsRespStructBuilder(_root_.scala.None, fieldTypes)

  override def encode(_item: TGetColumnsResp, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }


  private[this] def lazyDecode(_iprot: LazyTProtocol): TGetColumnsResp = {
    ...
    if (!_got_status) throw new TProtocolException("Required field 'status' was not found in serialized data for struct TGetColumnsResp")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): TGetColumnsResp =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[thrift] def eagerDecode(_iprot: TProtocol): TGetColumnsResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = null
    var _got_status = false
  ...
  def unapply(_item: TGetColumnsResp): _root_.scala.Option[_root_.scala.Tuple2[org.apache.hive.service.rpc.thrift.TStatus, Option[org.apache.hive.service.rpc.thrift.TOperationHandle]]] = _root_.scala.Some(_item.toTuple)
  ...
  object Immutable extends ThriftStructCodec3[TGetColumnsResp] {
    override def encode(_item: TGetColumnsResp, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): TGetColumnsResp = TGetColumnsResp.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[TGetColumnsResp] = TGetColumnsResp.metaData
  }

  /**
   * The default read-only implementation of TGetColumnsResp.  You typically should not need to
   * directly reference this class; instead, use the TGetColumnsResp.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the TGetColumnsResp trait with additional state or
   * behavior and implement the read-only methods from TGetColumnsResp using an underlying
   * instance.
   */
  trait Proxy extends TGetColumnsResp {
    protected def _underlying_TGetColumnsResp: TGetColumnsResp
    override def status: org.apache.hive.service.rpc.thrift.TStatus = _underlying_TGetColumnsResp.status
    override def operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = _underlying_TGetColumnsResp.operationHandle
    override def _passthroughFields: immutable$Map[Short, TFieldBlob] = _underlying_TGetColumnsResp._passthroughFields
  }
}

/**
 * Prefer the companion object's [[org.apache.hive.service.rpc.thrift.TGetColumnsResp.apply]]
 * for construction if you don't need to specify passthrough fields.
 */
trait TGetColumnsResp
  ...
  with ValidatingThriftStruct[TGetColumnsResp]
  with java.io.Serializable
{
  import TGetColumnsResp._
          ...
          _fieldId match {
            case 1 =>
              if (status ne null) {
                ...
                _root_.scala.Some(TGetColumnsResp.StatusField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (operationHandle.isDefined) {
                ...
                _root_.scala.Some(TGetColumnsResp.OperationHandleField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): TGetColumnsResp = {
   ...
   */
  def unsetField(_fieldId: Short): TGetColumnsResp = {
    var status: org.apache.hive.service.rpc.thrift.TStatus = this.status
    var operationHandle: _root_.scala.Option[org.apache.hive.service.rpc.thrift.TOperationHandle] = this.operationHandle
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStatus: TGetColumnsResp = unsetField(1)

  def unsetOperationHandle: TGetColumnsResp = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    TGetColumnsResp.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[TGetColumnsResp]

  private def _equals(x: TGetColumnsResp, y: TGetColumnsResp): Boolean =
  ...
  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[TGetColumnsResp])
  ...
  override def productPrefix: String = "TGetColumnsResp"

  def _codec: ValidatingThriftStructCodec3[TGetColumnsResp] = TGetColumnsResp

  def newBuilder(): StructBuilder[TGetColumnsResp] = new TGetColumnsRespStructBuilder(_root_.scala.Some(this), fieldTypes)
}

private[thrift] class TGetColumnsRespStructBuilder(instance: _root_.scala.Option[TGetColumnsResp], fieldTypes: IndexedSeq[ClassTag[_]])
    extends StructBuilder[TGetColumnsResp](fieldTypes) {

  def build(): TGetColumnsResp = instance match {
    ...
    case _root_.scala.None =>
      if (fieldArray.contains(null)) throw new InvalidFieldsException(structBuildError("TGetColumnsResp"))
      else {
        TGetColumnsResp(
