...
import org.apache.kyuubi.engine.flink.config.entries.ServerEntry;
 ...
 * EngineEnvironment files define server, session, catalogs, tables, execution, and deployment
