...
object SparkSQLEngine extends Logging {
  ...
  def createSpark(): SparkSession = {
    val engineCredentials = _sparkConf.getOption(KyuubiReservedKeys.KYUUBI_ENGINE_CREDENTIALS_KEY)
    _sparkConf.remove(KyuubiReservedKeys.KYUUBI_ENGINE_CREDENTIALS_KEY)
