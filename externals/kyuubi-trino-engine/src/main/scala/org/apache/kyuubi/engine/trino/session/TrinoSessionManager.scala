...
class TrinoSessionManager private (name: String, trinoContext: TrinoContext)
  extends SessionManager(name) {

  def this(trinoContext: TrinoContext) =
    this(classOf[TrinoSessionManager].getSimpleName, trinoContext)
