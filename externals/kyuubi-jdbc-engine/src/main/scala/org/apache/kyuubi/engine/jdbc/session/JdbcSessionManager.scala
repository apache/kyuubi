...
class JdbcSessionManager(name: String)
  ...
  override lazy val operationManager: OperationManager = getOperationManager(conf)
  ...
  private def getOperationManager(kyuubiConf: KyuubiConf): JdbcOperationManager = {
