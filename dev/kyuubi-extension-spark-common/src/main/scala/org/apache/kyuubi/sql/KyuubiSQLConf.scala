...
object KyuubiSQLConf {
  ...
  val INSERT_REPARTITION_BEFORE_WRITE =
    buildConf("kyuubi.spark.sql.optimizer.insertRepartitionBeforeWrite.enabled")
  ...
  val INSERT_REPARTITION_NUM =
    buildConf("kyuubi.spark.sql.optimizer.insertRepartitionNum")
  ...
  val DYNAMIC_PARTITION_INSERTION_REPARTITION_NUM =
    buildConf("kyuubi.spark.sql.optimizer.dynamicPartitionInsertionRepartitionNum")
  ...
  val FORCE_SHUFFLE_BEFORE_JOIN =
    buildConf("kyuubi.spark.sql.optimizer.forceShuffleBeforeJoin.enabled")
  ...
  val FINAL_STAGE_CONFIG_ISOLATION =
    buildConf("kyuubi.spark.sql.optimizer.finalStageConfigIsolation.enabled")
  ...
  val SQL_CLASSIFICATION_ENABLED =
    buildConf("kyuubi.spark.sql.analyzer.classification.enabled")
  ...
  val INSERT_ZORDER_BEFORE_WRITING =
    buildConf("kyuubi.spark.sql.optimizer.insertZorderBeforeWriting.enabled")
  ...
  val ZORDER_GLOBAL_SORT_ENABLED =
    buildConf("kyuubi.spark.sql.optimizer.zorderGlobalSort.enabled")
  ...
  val WATCHDOG_MAX_PARTITIONS =
    buildConf("kyuubi.spark.sql.watchdog.maxPartitions")
  ...
  val WATCHDOG_FORCED_MAXOUTPUTROWS =
    buildConf("kyuubi.spark.sql.watchdog.forcedMaxOutputRows")
  ...
  val DROP_IGNORE_NONEXISTENT =
    buildConf("kyuubi.spark.sql.optimizer.dropIgnoreNonExistent")
